...
class AppColors {
  // Primary purple — matches design #a855f7
  ...
  // Backgrounds
  static const Color background = Color(0xFFFBFAFF); // ultra-light lavender white
  ...
  static const Color accent = Color(0xFFa855f7);         // same as primary
