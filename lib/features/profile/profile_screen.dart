              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(name.isNotEmpty ? name : 'My Profile',
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _card([
                      if (user?.salonName != null && user!.salonName!.isNotEmpty)
                        _row(Icons.storefront_outlined, 'Salon Name', user.salonName!),
                    ...
                    const SizedBox(height: 8),
                    _card([
                      _row(Icons.location_on_outlined, 'Salon Address',
                    ...
                    const SizedBox(height: 8),
                    _card([
                      _navRow(context, Icons.receipt_long_outlined, 'Order History', () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (_) => const OrderHistoryScreen()));
                      }),
                      _divider(),
                      _navRow(context, Icons.help_outline, 'Help & Support', () {}),
                      _divider(),
                      _navRow(context, Icons.shield_outlined, 'Privacy Policy', () {}),
                    ]),
